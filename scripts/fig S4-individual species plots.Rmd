...
The figures created here using plotDetection12 shows ListLength on the x-axis. In this study we used categorical ListLengths and this is therefore equivalent to the 'datatype' categories in the paper. ListLength 1 = datatype1 = Natural History Museum of Denmark, Natural History Museum Aarhus, C. Skøtt, S. Schär and H. Holgersen. ListLength 2 = datatype2 = EuroAnts. ListLength 3 = datatype3 = The Ant Hunt.   