...
Camher_occ <- Camher + theme_classic(base_size = 12) + 
  ...
  labs(title = "Camponotus herculeanus")+
...
Forcun_occ <- Forcun + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Formica cunicularia")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
Forpre_occ <- Forpre + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Formica pressilabris")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
Fornit_occ <- Fornit + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Formicoxenus nitidulus")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
Myrsca_occ <- Myrsca + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Myrmica scabrinodis")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
# Occupancy and detection plots for species converged at 100,000 iterations

## Load data, 100,000 iterations 

```{r}
load("../output/para_out_100_nyr.Rdata")
...
Lepace_occ <- Lepace + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Leptothorax acervorum")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
Tetcae_occ <- Tetcae + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Tetramorium caespitum")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
# Occupancy and detection plots for species converged at 200,000 iterations

## Load data, 200,000 iterations 

```{r}
load("../output/para_out_200_nyr.Rdata")
...
# Occupancy and detection plots for species converged at 400,000 iterations

## Load data, 400,000 iterations 

```{r}
load("../output/para_out_400_nyr.Rdata")
...
# Occupancy and detection plots for species converged at 600,000 iterations

## Load data, 600,000 iterations 

```{r}
load("../output/para_out_600_nyr.Rdata")
...
Lasmer_occ <- Lasmer + theme_classic(base_size = 12) + 
  scale_x_discrete(name ="Time period", 
                    limits=c("1900-1909", "1910-1919", "1920-1929", 
                             ...
                             "1960-1969", "1970-1979", "1980-1989", 
                             "1990-1999", "2000-2009", "2010-2019")) +
  labs(title = "Lasius meridionalis")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position = "none", 
                           plot.title = element_text(size = 12, face = "italic")) +
  scale_y_continuous(limits=c(0,1), breaks=seq(0,1,0.1))
...
Combi <- plot_grid(Camher_occ, Camher_det2, Camher_l)
