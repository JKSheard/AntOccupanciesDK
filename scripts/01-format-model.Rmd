...
#Load data
```{r}
NHMDK <- read.csv("../data/Cleaned data/NHM_DK.csv", sep=";", header = TRUE)
Aarhus <- read.csv("../data/Cleaned data/Aarhus.csv", sep=";", header = TRUE)
Holgersen <- read.csv("..y/data/Cleaned data/Holgersen.csv", sep=";", header = TRUE)
Skoett <- read.csv("../data/Cleaned data/Skoett.csv", sep=";", header = TRUE)
Schar <- read.csv("../data/Cleaned data/Schar.csv", sep=";", header = TRUE)
EuroAnts <- read.csv("../data/Cleaned data/EuroAnts.csv", sep=";", header = TRUE)
AntHunt <- read.csv("../data/Cleaned data/Myrejagten.csv", sep=";", header = TRUE)
```
...
#Change to 4
formattedOccData_AH$occDetdata$L[formattedOccData_AH$occDetdata$L<5] <- 4
```

```{r}
#Export individual spp_vis and occDetdata files
write.csv(formattedOccData_AH$spp_vis, '../data/edited/spp_vis_AH.csv', row.names=FALSE)
write.csv(formattedOccData_AH$occDetdata, '../data/edited/occDetdata_AH.csv', row.names=FALSE)

write.csv(formattedOccData_EU$occDetdata, '../data/edited/occDetdata_EU.csv', row.names=FALSE)
write.csv(formattedOccData_EU$spp_vis, '../data/edited/spp_vis_EU.csv', row.names=FALSE)

write.csv(formattedOccData_SNM$spp_vis, '../data/edited/spp_vis_NHMDK.csv', row.names=FALSE)
write.csv(formattedOccData_SNM$occDetdata, '../data/edited/occDetdata_NHMDK.csv', row.names=FALSE)

write.csv(formattedOccData_Schar$spp_vis, '../data/edited/spp_vis_Schar.csv', row.names=FALSE)
write.csv(formattedOccData_Schar$occDetdata, '../data/edited/occDetdata_Schar.csv', row.names=FALSE)

write.csv(formattedOccData_Skoett$spp_vis, '../data/edited/spp_vis_Skoett.csv', row.names=FALSE)
write.csv(formattedOccData_Skoett$occDetdata, '../data/edited/occDetdata_Skoett.csv', row.names=FALSE)

write.csv(formattedOccData_Aarhus$spp_vis, '../data/edited/spp_vis_Aarhus.csv', row.names=FALSE)
write.csv(formattedOccData_Aarhus$occDetdata, '../data/edited/occDetdata_Aarhus.csv', row.names=FALSE)

write.csv(formattedOccData_Holgersen$spp_vis, '../data/edited/spp_vis_Holgersen.csv', row.names=FALSE)
write.csv(formattedOccData_Holgersen$occDetdata, '../data/edited/occDetdata_Holgersen.csv', row.names=FALSE)
```
...
write.csv(occDetdata_merged, '../data/edited/occDetdata_merged.csv', row.names=FALSE)

#Export  spp_vis datasets
write.csv(spp_vis_merged, '../data/edited/spp_vis_merged.csv', row.names=FALSE)
```